...
class ContractTest {
    ...
    @Test
    void addItem_validInput_shouldNotThrow() {
        assertThatCode(() -> cart.addItem(product, 2))
    ...
    // ======================================================
    // SHOPPING CART - applyDiscount
    // ======================================================

    @Test
    void applyDiscount_valid_shouldNotThrow() {
        cart.addItem(product, 2);

        assertThatCode(() -> cart.applyDiscount(20))
                .doesNotThrowAnyException();
    }

    @Test
    void applyDiscount_invalid_shouldViolatePreCondition() {
    ...
    @Test
    void calculate_valid_shouldNotThrow() {
        assertThatCode(() ->
    ...
    void calculate_invalidDiscount_shouldViolatePreCondition() {
        assertThatThrownBy(() ->
                calculator.calculate(100, 150, 10)
        ).isInstanceOf(AssertionError.class);
    }
